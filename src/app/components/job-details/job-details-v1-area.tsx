	...
	<div className="container">
		<div className="row">
			...
			<div className="col-xxl-3 col-xl-4">
				...
				<Image src={job?.company_logo!==null?`https://fipiqdxkchoddvgjmhdz.supabase.co/storage/v1/object/public/employer_avatars/${job?.company_logo}`: job.company.avatar?`https://fipiqdxkchoddvgjmhdz.supabase.co/storage/v1/object/public/employer_avatars/${job?.company.avatar}`:"/assets/images/candidates/01.png"} alt="company-logo" className="lazy-img rounded-circle m-auto" style={{objectFit:"cover", width:"60px", height:"60px",aspectRatio:"1/1"}} width={60} height={60} />
				<div className="text-md text-dark text-center mt-15 mb-20 text-capitalize">{job.company_name?job.company_name:job.company.company_name}</div>
