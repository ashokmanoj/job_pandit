  ...
  return (
    <div className="user-avatar-setting d-flex align-items-center mb-30">
      <Image
        src={
          avatar
            ? `https://fipiqdxkchoddvgjmhdz.supabase.co/storage/v1/object/public/employer_avatars/${avatar}`
            : "/assets/images/candidates/01.png"
        }
        alt="avatar"
      ...
      <button
        ...
        onClick={() => handleDeletePhoto(avatar)}
      >
        Delete
      </button>
    </div>
